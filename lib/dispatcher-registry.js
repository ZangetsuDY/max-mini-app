...
export const DISPATCHER_UNIT_REGISTRY = Object.freeze([
  ...
  // ОС — порядок приведён к списку файлов пользователя.
  // Новые элементы добавлены БЕЗ источников по умолчанию:
  // разработчик сможет назначить строки СК-11 через интерфейс.
  ...
  { id: "os-gtes", groupId: "os", name: "ОС ГтЭС", defaultSources: [] },
  ...
  { id: "os-ves", groupId: "os", name: "ОС ВЭС", defaultSources: [] },
  { id: "os-spbbs", groupId: "os", name: "СПбБС", defaultSources: [] },
  { id: "os-yues", groupId: "os", name: "ОС ЮЭС", defaultSources: [] }
]);
